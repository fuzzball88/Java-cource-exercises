/*
* Chapter8.java
* Made for Viope course, chapter eight
...
public class Chapter8 {
	...
	*/
	...
	// MAIN METHO/existing-content//existing-content//existing-content////////
	public static void main(String[] args) {
		...
		System.out.println("- - - - -");
		System.out.println(name + "?s jumps from shortest to longest:");
		printer(jumps);
		System.out.println("Average length of the jumps " + average(jumps));
	}
}
